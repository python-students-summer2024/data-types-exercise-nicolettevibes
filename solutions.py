...
def calculate_quotient_and_remainder():
    ...
    quotient = (num1) // (num2)
    remainder = (num1) % (num2)
    print ("{} goes into {} a total of {} times with a remainder of {}". format(num2, num1, quotient, remainder))
...
def calculate_miles_per_gallon():
    ...
    gallons_of_gas_used = input("Gas used (gallons): ")
    mpg = float(miles_driven) / float(gallons_of_gas_used)
    output = "Miles driven: {}\nGas used (gallons): {}\nMiles per gallon: {:.1f}".format(miles_driven, gallons_of_gas_used, mpg)
    print(output)
